...
map_modules:
	...
	.byte	0x77, 0xe4, 0x5b, 0x87, 0xd6, 0x2b, 0xbd, 0x40, 0x92, 0xad, 0xf1, 0xfa, 0x66, 0xf1, 0x81, 0x7d	// module_uuid: 875be477-2bd6-40bd-92ad-f1fa66f1817d
	...
	.byte	0x95, 0x86, 0x1e, 0x1, 0x88, 0x85, 0xb9, 0x4b, 0x82, 0xde, 0x64, 0x7c, 0x18, 0x5, 0xe8, 0xff	// module_uuid: 011e8695-8588-4bb9-82de-647c1805e8ff
	.word	0x3	// entry_count
	.word	0x0	// duplicate_count
	...
	.byte	0xfe, 0x1b, 0xa5, 0xf7, 0xc0, 0xf3, 0xde, 0x41, 0xab, 0x87, 0xc9, 0x8c, 0x9a, 0x82, 0xfe, 0x95	// module_uuid: f7a51bfe-f3c0-41de-ab87-c98c9a82fe95
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module34_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.34	// assembly_name: TiruCommunityAndroid
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x2000010	// type_token_id
	.ascii	"crc6434d0a0f60155b6fc/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x22	// module_index
	.word	0x2000011	// type_token_id
	.ascii	"crc6434d0a0f60155b6fc/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
